    ...
    <body>
		...
		<div class="content">
			<form action="login.php" method="post">
				<div class="center">
					<label for="username">Username</label><input required=true type="text" name="username" id="username" value="<?php echo htmlentities($ousername, ENT_QUOTES, 'UTF-8'); ?>" /><br />
					<br/>
					<label for="password">Password</label><input  required=true type="password" name="password" id="password" /><br />
					<br/>
